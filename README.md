...
В данном репозитории находится полностью автономный набор конфигураций для **Neovim** версии 0.12.1 (собирал из исходников, что-то по-другому вроде не получилось. Или я это сдплал по-приколу, не помню) Всё написано на Lua и управляется менеджером плагинов **lazy.nvim**.
